...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 25cef9a9-00d6-421d-a23f-688b28cbe74b
```

> `25cef9a9-00d6-421d-a23f-688b28cbe74b` is the password of the certificate, you can change it to any password you want.
